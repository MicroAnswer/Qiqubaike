...
import com.microanswer.qiqubaike.activity.JinXuanDetailActivity;
...
public class ItemHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        if (position >= 1) {
            if (jinXuanItem != null) {
                ...
                try {
                    ...
                    if (textContent != null && !textContent.hasOnClickListeners()) {
    ...
    protected void onTextContentClick() {
        Intent intent = new Intent(context, JinXuanDetailActivity.class);
        intent.putExtra("id", jinXuanItem.getId());
